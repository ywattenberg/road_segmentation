...
chicago = [{"n": 42.072123, "w": -88.311501, "s": 41.643560, "e": -87.682533}]

houston = [{"n": 29.875249, "w": -95.563377, "s": 29.610542, "e": -95.189842}]

phoenix = [{"n": 33.688554, "w": -112.381892, "s": 33.392095, "e": -111.887507}]
...
boston = [{"n": 42.387338, "w": -71.141267, "s": 42.283792, "e": -71.046510}]
cities_boxes = [
    los_angeles,
    chicago,
    houston,
...
def get_and_safe_img(x_vals, y_vals):
    for x in x_vals:
        for y in y_vals:
            ...
            if os.path.exists(
                "data/additional_data/images/{}-{}.png".format(x_fmt, y_fmt)
            ):
                continue
