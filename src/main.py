...
if __name__ == "__main__":
    ...
    trainer = Trainer(model, dataset, None, loss_fn, None, split_test=0.2, batch_size=4, epochs=10, test_metrics=[JaccardLoss(mode='binary'), loss_fn], test_metric_names=["JaccardLoss", "DiceLoss"], epochs_between_safe=10)
